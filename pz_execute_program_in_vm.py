...
for ipchange
C:\Exercies_py>python execute_program_in_vm.py -s 10.180.1.8 -u pixel8networks\p
andas -p PanBar168 -v 10.201.15.55 -r support -w admin -l /sbin/ifconfig  -f "vm
x0 10.201.10.58/24 > /tmp/zahid"
Program executed, PID is 21998

for gateway change
C:\Exercies_py>python execute_program_in_vm.py -s 10.180.1.8 -u pixel8networks\p
andas -p PanBar168 -v 10.201.10.58 -r support -w admin -l /sbin/route  -f "add d
efault 10.201.10.1 > /tmp/zahid"
Program executed, PID is 23691
